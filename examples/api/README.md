...
Sending referral documents will first save the documents in the HQ branch under Client > Attachments > Marketplace Documents before sharing the file with the agency. The agency will then automatically save the files in the agency branch under Client > Attachments > Marketplace Documents once the referral is processed. 
